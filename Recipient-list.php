...
<div id="full">
    <div id="inner_full">
        ...
        <div id="body">
            ...
            <h1>Recipient List</h1><br>
            <center><div id="form">
                <table>
                    <tr>
                        <td><center><b><font color="blue">Name</font></b></center></td>
                        <td><center><b><font color="blue">Date of Receiving</font></b></center></td>
                    ...
                    <?php
                    $q=$db->query("SELECT* FROM recipient1");
                    while($r1=$q->fetch(PDO::FETCH_OBJ))
                    {
                        ?>
                        <tr>
                        <td><center><?= $r1->name; ?></center></td>
                        <td><center><?= $r1->date_of_receiving; ?></center></td>
